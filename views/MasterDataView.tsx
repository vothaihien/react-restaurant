    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white border border-gray-200 p-4 rounded-lg">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Nhà cung cấp</h3>
                <div className="flex gap-2 mb-3">
                    <input className="bg-white text-gray-900 rounded px-3 py-2 border border-gray-300" placeholder="Tên nhà cung cấp" value={name} onChange={(e) => setName(e.target.value)} />
            ...
            <div className="bg-white border border-gray-200 p-4 rounded-lg">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Bàn ăn</h3>
                <div className="flex flex-col sm:flex-row gap-2 mb-3">
                    <input className="bg-white text-gray-900 rounded px-3 py-2 border border-gray-300" placeholder="Tên bàn" value={tableName} onChange={(e) => setTableName(e.target.value)} />
                    <input type="number" className="bg-white text-gray-900 rounded px-3 py-2 border border-gray-300" placeholder="Sức chứa" value={capacity} onChange={(e) => setCapacity(parseInt(e.target.value) || 2)} />
            ...
            <div className="bg-white border border-gray-200 p-4 rounded-lg">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Nhân viên & Vai trò</h3>
