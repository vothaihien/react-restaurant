...
import EMenuView from "@/components/EMenuView";
import MenuTheoKhungGio from "@/components/MenuTheoKhungGio";
      ...
      <Tabs value={tab} onValueChange={(v) => onTabChange(v as CustomerTab)}>
        ...
        <TabsContent value="menu">
          <div className="space-y-6">
            {/* Tab menu theo khung giờ và E-menu */}
                  ...
                  {loadingCategories ? (
                    ...
                    <div className="mb-3">
                      <p className="text-sm text-gray-500">
                        Chưa có danh mục nào. Danh mục sẽ được hiển thị khi có
                        dữ liệu.
                      </p>
                    </div>
                  )}
